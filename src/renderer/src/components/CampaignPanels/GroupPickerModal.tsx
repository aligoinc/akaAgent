    ...
    <div className="modal-overlay" style={{ zIndex: 2000 }}>
      <div style={{
        ...
        <div style={{ padding: '12px 20px 8px', position: 'relative' }}>
          ...
          <input
            type="text"
            placeholder="Tìm kiếm theo tên nhóm hoặc UID..."
            value={search}
        ...
        <div style={{
          ...
          {loading ? (
            ...
            <div style={{ padding: 40, textAlign: 'center', color: 'var(--text-tertiary)' }}>
              {contacts.length === 0
                ? 'Chưa có nhóm. Hãy load danh sách nhóm trong tab Trình duyệt trước.'
        ...
        <div style={{
          ...
          >
            Thêm {selectedIds.size > 0 ? `${selectedIds.size} nhóm` : ''}
          </button>
        </div>
      </div>
    </div>
