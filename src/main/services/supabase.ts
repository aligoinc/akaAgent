...
export class SupabaseService {
  ...
  getDataGroupAccountOptions(query: DataGroupAccountOptionsQuery) {
    return dataGroupRepo.getDataGroupAccountOptions(query)
  }
  ...
  listZaloFriendBlocklistPage(accountId: number, query: ZaloFriendBlocklistPageQuery) {
    return accountContactRepo.listZaloFriendBlocklistPage(accountId, query)
  }
